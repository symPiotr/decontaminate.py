...
e.g.,  decontaminate.py Test.count_table Test_blanks.txt 10 0.001 0.3\n
...
<ThresholdC>        Value representing the threshold parameter for filtation step (c) above; an experimental library will be removed if it retains less than ThresholdC of the starting number of reads. Recommended value: 0.3
...
for row in Count_table:
    for cell in row:
        print(cell, end="\t", file = OUTPUT_COUNT_TABLE)
    print("\n", file = OUTPUT_COUNT_TABLE)
